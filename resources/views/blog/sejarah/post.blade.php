...
<body class="bg-white font-family-karla">
    ...
    <div class="container mx-auto flex flex-wrap py-6">
        ...
        <section class="w-full md:w-2/3 flex flex-col items-center px-3 mx-auto">
            ...
            <article class="flex flex-col shadow my-4 xs:w-[90%]">
                <!-- Article Image -->
                ...
                <div class="bg-white flex flex-col justify-start rounded-lg p-3" style="border-radius: 0 0 25px 25px; background-image: url('images/Rectangle_57.jpg'); background-repeat:repeat-y">
                    ...
                    <a href="#" class="md:text-3xl xs:text-xl font-bold hover:text-gray-700 pb-4">Lorem Ipsum Dolor Sit Amet Dolor Sit Amet</a>
                    ...
                    <div class=" flex flex-wrap md:gap-7 xs:gap-2 xs:px-1 mx-auto bg-blue-700 rounded-lg mb-5">
                        <div class="hover:bg-gray-300 md:p-3 xs:p-1">             
                        <a href="#" class="text-white hover:text-black text-sm md:font-bold uppercase rounded-lg h-fit ">Sejarah</a>
                        </div>
                        <div class="hover:bg-gray-300 md:p-3 xs:p-1">
                        <a href="#" class="text-white hover:text-black text-sm md:font-bold uppercase rounded-lg h-fit">Kajian</a>
                        </div>
                        <div class="hover:bg-gray-300 md:p-3 xs:p-1">
                        <a href="#" class="text-white hover:text-black text-sm md:font-bold uppercase rounded-lg h-fit">Kegiatan</a>
                        </div>
                        <div class="hover:bg-gray-300 md:p-3 xs:p-1" >
                        <a href="#" class="text-white hover:text-black text-sm md:font-bold uppercase rounded-lg h-fit">Shalat</a>
                        </div>
                        <div class="hover:bg-gray-300 md:p-3 xs:p-1">
                        <a href="#" class="text-white hover:text-black text-sm md:font-bold uppercase rounded-lg h-fit">Ziswaf</a>
                            </div>
                    </div>

                    <h1 class="md:text-2xl xs:text-lg font-bold pb-3">Introduction</h1>
                    ...
                    <h1 class="md:text-2xl xs:text-lg font-bold pb-3">Heading</h1>
                    ...
                    <h1 class="md:text-2xl xs:text-lg font-bold pb-3">Conclusion</h1>
